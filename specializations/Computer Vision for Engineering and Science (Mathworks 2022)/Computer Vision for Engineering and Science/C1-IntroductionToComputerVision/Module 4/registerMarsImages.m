...
% Auto-generated by registrationEstimator app on 26-Dec-2022
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',901.249886,'NumOctaves',2,'NumScaleLevels',4);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',901.249886,'NumOctaves',2,'NumScaleLevels',4);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',30.750008,'MaxRatio',0.307500);
