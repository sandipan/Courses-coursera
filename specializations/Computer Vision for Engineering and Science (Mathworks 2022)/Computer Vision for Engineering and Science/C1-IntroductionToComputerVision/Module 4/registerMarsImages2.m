...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',900.000000,'NumOctaves',2,'NumScaleLevels',4);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',900.000000,'NumOctaves',2,'NumScaleLevels',4);
