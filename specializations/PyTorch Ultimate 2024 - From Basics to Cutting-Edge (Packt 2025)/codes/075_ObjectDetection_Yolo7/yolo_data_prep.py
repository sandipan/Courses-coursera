...
base_folder = '075_ObjectDetection_Yolo7\\'
create_folder(base_folder + 'yolov7\\train\\images')
create_folder(base_folder + 'yolov7\\train\\labels')
create_folder(base_folder + 'yolov7\\val\\images')
create_folder(base_folder + 'yolov7\\val\\labels')
create_folder(base_folder + 'yolov7\\test\\images')
create_folder(base_folder + 'yolov7\\test\\labels')
...
for f in files:
        ...
        if pos < 700:
            dest_folder = base_folder + 'yolov7\\train'
        elif (pos >= 700 and pos < 800):
            dest_folder = base_folder + 'yolov7\\val'
        else:
            dest_folder = base_folder + 'yolov7\\test'
        ...
        label_source_path = os.path.join(base_folder, 'annotations', label_source_file)
