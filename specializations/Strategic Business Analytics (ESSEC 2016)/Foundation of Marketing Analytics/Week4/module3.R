...
prob.model.mod = multinom(formula = active_2015 ~ recency + log(recency) + frequency + log(frequency),
                      data = in_sample)

coef = summary(prob.model.mod)$coefficients
std  = summary(prob.model.mod)$standard.errors
print(coef)
print(std)
print(coef / std)
...
customers_2015$prob_predicted    = predict(object = prob.model.mod, newdata = customers_2015, type = "probs")
...
head(customers_2015$customer_id, 10)
head(customers_2015$prob_predicted, 10)
head(customers_2015$revenue_predicted, 10)
head(customers_2015$score_predicted, 10)

customers_2014[customers_2014$customer_id == 190,]
