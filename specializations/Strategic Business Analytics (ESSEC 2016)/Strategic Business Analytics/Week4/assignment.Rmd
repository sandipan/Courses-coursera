...
```{r, fig.width=40, fig.height=20, echo=FALSE, warning=FALSE, message=FALSE}
ggplot(df, aes(x=dteday)) + 
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1), text = element_text(size = 20), legend.title =  element_text("Bike Rental Counts"))
```
...
ggplot(df, aes(x=dteday)) + 
  ...
  xlab('Date') +
  ylab('Total number of Bikes') +
  theme(axis.text.x = element_text(angle = 90, hjust = 1), text = element_text(size = 25), legend.title =  element_text("Bike Rental Counts"))
```
...
ggplot(df2, aes(x=hr)) + 
  ...
  theme(text = element_text(size = 25), legend.title =  element_text("Bike Rental Counts"))
```
