...
folder_path = '350_SemiSupervised/data/unlabeled'
unlabeled_ds = UnlabeledDataset(folder_path)


#%% Dataset for train and test
train_ds = torchvision.datasets.ImageFolder(root='350_SemiSupervised/data/train', transform=transform_super)
test_ds = torchvision.datasets.ImageFolder(root='350_SemiSupervised/data/test', transform=transform_super)
...
# %%
print(accuracy_score(y_pred=y_test_preds, y_true=y_test_trues))
# %%
