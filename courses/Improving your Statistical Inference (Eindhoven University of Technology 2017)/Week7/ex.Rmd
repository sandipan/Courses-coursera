...
* **Supporting the alternative with Bayes Factors**: As can be seen from the following results, the **alternative hypothesis** has become \(50.17844\) times more likely than the **null hypothesis** (as **poterior belief**), with **small prior belief on effect size**.
