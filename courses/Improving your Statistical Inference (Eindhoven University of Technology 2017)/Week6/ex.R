...
N <- 250 #100 #Enter sample size
dz <- 0.05 #0.25 #Enter Cohen's dz effect size observed in the dependent t-test or one-sided t-test

dz_prior <- 0.3 #0.1 #0.3 #0.32 #Enter effect size dz for the prior 
