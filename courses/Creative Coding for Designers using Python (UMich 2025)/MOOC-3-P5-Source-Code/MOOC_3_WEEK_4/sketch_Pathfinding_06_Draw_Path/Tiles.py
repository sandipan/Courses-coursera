...
class Tile:
    ...
    def __init__(self, pos, cell_size, type, cols, rows, x, y, all_cells):
        ...
        self.parent = None # Tile which was propagated that led to this tile
    ...
    def change_type(self, type):
        ...
        self.current_type = type  # Set the tile's current type to the specified type.
        if(type == 1 or type == 3):  # If the type indicates an obstacle...
            self.isObstable = True  # Mark the tile as an obstacle.
        else:
            self.isObstable = False  # Otherwise, mark it as not an obstacle.
