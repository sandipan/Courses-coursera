...
class Herbivore:
    ...
    def __init__ (self, pos, all_food, all_herbivores):
        ...
        self.hunger_threshold = 300  # Set the hunger threshold of the herbivore
        self.rest_level = 0  # Initialize the rest level of the herbivore
        self.rest_threshold = 50  # Set the rest threshold of the herbivore
        ...
        self.starvation_threshold = 100  # Set the starvation threshold
