...
for k = 1 : length(phenotypeFactor.val)
	...
	if (parent1Alleles == parent2Alleles)
		genotypeFactor.val(k) = alleleFreqs(allele1) * alleleFreqs(allele2);
	else
		genotypeFactor.val(k) = 2 * alleleFreqs(allele1) * alleleFreqs(allele2);
	end
	...
	phenotypeFactor.val(k) = count / totalPossibleOutcomes;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%